...
cmd_status() {
    ...
    FMAP["PxPlus Tandy1K-II 200L"]="Tandy 1000"
    FMAP["PxPlus IBM VGA 9x16"]="IBM PS/2 VGA"
    FMAP["Topaz a500a1000a2000"]="Amiga 500, WorkBench 2"
    FMAP["Silkscreen"]="Apple Macintosh 128K"
    FMAP["Terminus"]="SVGA, Trinitron, Minimaal"
    FMAP["Pet Me 2Y"]="Commodore PET 2001"
